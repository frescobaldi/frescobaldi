; Adapted from pynsist's default script
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  [% block install_associations %]
  ; Register file associations
  [% if single_shortcut %]
    [% for scname, sc in ib.shortcuts.items() %]
    WriteRegStr HKCR ".ly" "" "Frescobaldi.ly"
    WriteRegStr HKCR "Frescobaldi.ly" "" "LilyPond Source File"
    WriteRegStr HKCR "Frescobaldi.ly\DefaultIcon" "" "$INSTDIR\[[ sc['icon'] ]]"
    WriteRegStr HKCR "Frescobaldi.ly\shell" "" "open"
    WriteRegStr HKCR "Frescobaldi.ly\shell\open\command" "" '"[[ sc['target'] ]]" [[ sc['parameters'] ]] "%1"'
    [% endfor %]
  [% endif %]
  [% endblock install_associations %]
...
Section "Uninstall"
  ...
  [% block uninstall_associations %]
  ; Unregister file associations
  DeleteRegKey HKCR ".ly"
  DeleteRegKey HKCR "Frescobaldi.ly"
  [% endblock uninstall_associations %]
