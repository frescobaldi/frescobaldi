...
class Document(QObject):
    """
    Abstract base class representing a VCS controlled document.
    This 'document' does not contain the content of a document
    but only its VCS status and metadata.
    """
    ...
    def _create_tmp_files(self):
        """
        Create the (VCS dependent) temporary files to handle the
