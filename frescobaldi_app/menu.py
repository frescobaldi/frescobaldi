...
def menu_music(mainwindow):
    ...
    m.addAction(ac.music_raster)
    m.addSeparator()
    m.addAction(ac.music_horizontal)
    m.addAction(ac.music_vertical)
    m.addAction(ac.music_continuous)
    m.addSeparator()
    m.addAction(ac.music_rotate_right)
    m.addAction(ac.music_rotate_left)
    m.addSeparator()
